...
//                                val hasDependencies = dependenciesNode.children().any {
//                                    it is groovy.util.Node && it.name() == "dependencies"
//                                }
//                                if (!hasDependencies){
//                                    dependenciesNode = dependenciesNode.appendNode("dependencies")
//                                }else{
//                                    dependenciesNode = dependenciesNode.get("dependencies")
//                                }
//
//                                // 在执行时获取依赖，而不是配置时
...
//                                        version = versionToPublished
//                                    } else {
//                                        groupId = dep.group?: "unknown.group"
